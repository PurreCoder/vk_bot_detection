...
def check_predictions():
    ...
    id_list = [
               # humans
               98947872, 560901763, 562121454, 562782278, 568925934,
               569516195, 571088829, 573134360, 578138997, 581000831,
               # bots
               422046288, 422041826, 422039815, 422035299, 422034314,
               422030585, 422020816, 422016591, 422008651, 421997796
    ]
